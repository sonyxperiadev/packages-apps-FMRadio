...
jboolean openDev(JNIEnv *env ATTRIBUTE_UNUSED, jobject thiz ATTRIBUTE_UNUSED)
{
    int ret = 0;
...
jboolean closeDev(JNIEnv *env ATTRIBUTE_UNUSED, jobject thiz ATTRIBUTE_UNUSED)
{
    int ret = 0;
...
jboolean powerUp(JNIEnv *env ATTRIBUTE_UNUSED, jobject thiz ATTRIBUTE_UNUSED, jfloat freq)
{
    int ret = 0;
    int tmp_freq;
...
jboolean powerDown(JNIEnv *env ATTRIBUTE_UNUSED, jobject thiz ATTRIBUTE_UNUSED, jint type)
{
    int ret = 0;
...
jboolean tune(JNIEnv *env ATTRIBUTE_UNUSED, jobject thiz ATTRIBUTE_UNUSED, jfloat freq)
{
    int ret = 0;
    int tmp_freq;
...
jfloat seek(JNIEnv *env ATTRIBUTE_UNUSED, jobject thiz ATTRIBUTE_UNUSED, jfloat freq, jboolean isUp) //jboolean isUp;
{
    int ret = 0;
    int tmp_freq;
    int ret_freq;
...
jshortArray autoScan(JNIEnv *env, jobject thiz ATTRIBUTE_UNUSED)
{
...
jshort readRds(JNIEnv *env ATTRIBUTE_UNUSED, jobject thiz ATTRIBUTE_UNUSED)
{
    int ret = 0;
    uint16_t status = 0;
...
jbyteArray getPs(JNIEnv *env, jobject thiz ATTRIBUTE_UNUSED)
{
    int ret = 0;
    jbyteArray PSname;
    uint8_t *ps = NULL;
...
jbyteArray getLrText(JNIEnv *env, jobject thiz ATTRIBUTE_UNUSED)
{
    int ret = 0;
...
jshort activeAf(JNIEnv *env ATTRIBUTE_UNUSED, jobject thiz ATTRIBUTE_UNUSED)
{
    int ret = 0;
    jshort ret_freq = 0;
...
jshortArray getAFList(JNIEnv *env, jobject thiz ATTRIBUTE_UNUSED)
{
    int ret = 0;
    jshortArray AFList;
    char *af = NULL;
...
jint setRds(JNIEnv *env ATTRIBUTE_UNUSED, jobject thiz ATTRIBUTE_UNUSED, jboolean rdson)
{
    int ret = 0;
    int onoff = -1;
...
jboolean stopScan(JNIEnv *env ATTRIBUTE_UNUSED, jobject thiz ATTRIBUTE_UNUSED)
{
    int ret = 0;
...
jint setMute(JNIEnv *env ATTRIBUTE_UNUSED, jobject thiz ATTRIBUTE_UNUSED, jboolean mute)
{
    int ret = 0;
 ...
 *      -1: error
 ******************************************/
jint isRdsSupport(JNIEnv *env ATTRIBUTE_UNUSED, jobject thiz ATTRIBUTE_UNUSED)
{
    int ret = 0;
    int supt = -1;
 ...
 *          2: Not support
 ******************************************/
jint switchAntenna(JNIEnv *env ATTRIBUTE_UNUSED, jobject thiz ATTRIBUTE_UNUSED, jint antenna)
{
    int ret = 0;
    jint jret = 0;
    int ana = -1;
...
jint JNI_OnLoad(JavaVM* vm, void* reserved ATTRIBUTE_UNUSED)
{
